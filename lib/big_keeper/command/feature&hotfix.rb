    ...
    command GitflowType.command(type) do |c|
      ...
      c.command :start do |start|
        start.action do |global_options, options, args|
          ...
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/start")
      ...
      c.command :update do |update|
        update.action do |global_options, options, args|
          path = File.expand_path(global_options[:path])
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/update")
      ...
      c.command :switch do |switch|
        switch.action do |global_options, options, args|
          ...
          version = global_options[:ver]
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/switch")
      ...
      c.command :pull do |pull|
        pull.action do |global_options, options, args|
          path = File.expand_path(global_options[:path])
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/pull")
      ...
      c.command :push do |push|
        push.action do |global_options, options, args|
          path = File.expand_path(global_options[:path])
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/push")
      ...
      c.command :rebase do |rebase|
        rebase.action do |global_options, options, args|
          path = File.expand_path(global_options[:path])
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/rebase")
      ...
      c.command :finish do |finish|
        finish.action do |global_options, options, args|
          path = File.expand_path(global_options[:path])
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/finish")
      ...
      c.command :publish do |publish|
        publish.action do |global_options, options, args|
          path = File.expand_path(global_options[:path])
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/publish")
      ...
      c.command :delete do |delete|
        delete.action do |global_options, options, args|
          path = File.expand_path(global_options[:path])
          user = global_options[:user].gsub(/[^0-9A-Za-z]/, '').downcase
          LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/delete")
      ...
      c.command :list do |list|
        ...
        list.command :tree do |tree|
          tree.action do |global_options, options, args|
            LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/list/tree")
        ...
        list.command :json do |json|
          json.action do |global_options, options, args|
            LeanCloudLog.instance.set_command("#{GitflowType.command(type)}/list/json")
